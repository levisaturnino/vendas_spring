    ...
    protected void doFilterInternal(
        ...
        if (authorization != null && authorization.startsWith("Bearer")) {
            ...
            if (isValid) {
                ...
                UsernamePasswordAuthenticationToken usernamePassword = new UsernamePasswordAuthenticationToken(userDetails, null
                        , userDetails.getAuthorities());
                usernamePassword.setDetails(new WebAuthenticationDetailsSource().buildDetails(httpServletRequest));
